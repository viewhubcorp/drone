...
<div class="login-box">
    ...
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="" class="h1"><b>Canaveral</b>OS</a>
        </div>
        <div class="card-body">
            @error('username')
            ...
            <form method="POST" action="{{ route('login', [], false) }}">
                ...
                <div class="input-group mb-3">
                    <input type="password" name="password" required class="form-control" placeholder="Пароль" autocomplete="off">
                    <div class="input-group-append">
                        <div class="input-group-text">
                            <span class="fas fa-lock"></span>
                        </div>
                    </div>
                </div><button type="submit" class="btn btn-block btn-primary">Войти</button>
